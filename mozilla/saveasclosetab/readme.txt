...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\saveasclosetab on
     Windows, /home/user/dev/saveasclosetab on Linux) in a file named
     saveasclosetab@binarymillenium and copy that file to
